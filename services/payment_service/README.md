...
```
python3 -m services.payment_service.main --output local --num-customers 1000                        # v1: PAID
python3 -m services.payment_service.main --output local --num-customers 1000 --contract-version v2  # v2: SETTLED
```

## Docker

```
docker build -f services/payment_service/Dockerfile -t payment-service .
