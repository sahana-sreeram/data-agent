...
```
python3 -m demo.services.application_service.main --output local --num-customers 1000
python3 -m demo.services.application_service.main --output s3 --seed 42 --num-customers 1000
```

## Docker

```
docker build -f demo/services/application_service/Dockerfile -t application-service .
