...
narrates those calls for a demo audience; it adds no new diagnosis/repair/verification logic.
    ...
    python3 -m demo.enterprise_incident --healthy-only
    python3 -m demo.enterprise_incident --inject-contract-change
    python3 -m demo.enterprise_incident --inject-contract-change --run-repair
