...
from src.legacy.diagnose_incident import DiagnoseIncidentError, parse_args, run_diagnose_incident
...
def test_safety_source_and_raw_files_untouched_by_full_diagnosis_run(tmp_path):
    transform_path = Path("src/legacy/transform.py")
...
def test_no_subprocess_usage_anywhere_in_diagnosis_modules():
    diagnosis_modules = [
        "src/legacy/diagnostic_tools.py",
        "src/legacy/diagnosis_agent.py",
        "src/legacy/diagnose_incident.py",
        "src/model_client.py",
        "src/legacy/diagnosis_models.py",
    ]
