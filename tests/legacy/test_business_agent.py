...
from src.legacy.answer_models import AnswerStatus, AnswerValidationError
from src.legacy.business_agent import SUBMIT_ANSWER_TOOL_NAME, BusinessAgentError, run_business_qa
...
def test_no_subprocess_usage_in_business_agent_module():
    tree = ast.parse(Path("src/legacy/business_agent.py").read_text())
