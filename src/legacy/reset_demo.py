...
(`src/legacy/demo_snapshot/`), and clearing the transient diagnosis/repair/answer
...
DEFAULT_SNAPSHOT_DIR = Path("src/legacy/demo_snapshot")

# Files the two re-breakable demos actually mutate. Restored byte-for-byte
# from the snapshot. src/legacy/transform.py is shared by both incorrect_join's and
