"""Shared repair-agent planning-loop building blocks: the submit_repair_plan tool schema,
system prompt, and small helpers reused by src/lifecycle_repair_agent.py's actual tool-calling
loop (run_lifecycle_repair_planning) for every one of the 5 registered lifecycle pipelines.
"""
