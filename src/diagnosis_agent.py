"""Shared diagnosis-agent reasoning-loop building blocks: the submit_diagnosis tool schema,
system prompt, and small helpers reused by src/lifecycle_diagnosis_agent.py's actual
tool-calling loop (run_lifecycle_diagnosis) for every one of the 5 registered lifecycle
pipelines, and by src/agents/codex_mcp_loop.py / demo/enterprise_incident.py.
"""
...
from src.model_client import ToolCall
